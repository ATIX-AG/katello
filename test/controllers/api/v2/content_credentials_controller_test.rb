...
module Katello
  class Api::V2::ContentCredentialsControllerTest < ActionController::TestCase
    ...
    def test_content
      ...
      post :content, :id => @gpg_key.id, :content_type => "gpg_key", :content => Rack::Test::UploadedFile.new(temp_content_file.path, "text/plain")
    ...
    def test_cert_content
      ...
      temp_content_file.write(content)
      temp_content_file.rewind
      post :content, :id => @cert.id, :content_type => "cert", :content => Rack::Test::UploadedFile.new(temp_content_file.path, "text/plain")
      assert_response :success, @response.body
