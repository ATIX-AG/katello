module Katello
  class Api::V2::SimpleContentAccessController < Api::V2::ApiController
    ...
    def eligible
      ::Foreman::Deprecation.api_deprecation_warning(N_("This endpoint is deprecated and will be removed from orcharhino in the future. All organizations are now eligible for Simple Content Access."))
